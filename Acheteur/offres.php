<div class="offres col-lg-10 mx-auto"  style=float:none>
    ...
    <?php
        ...
        $query = "SELECT * FROM offres WHERE ID_Acheteur=". $ID_Acheteur ." AND Accepted=0 ORDER BY Date DESC";
        ...
        while($row = $result->fetch_assoc()) 
        {
            ...
            <tr style="text-align: justify;">
                ...
                <td>
                	<?php if ($row["Instigateur"] == "Acheteur") echo 'Tu as fait une offre à '; ?>
                    <?php $vendeur = mysqli_query($db_handle, "SELECT Boutique FROM vendeurs WHERE ID=" . $item["ID_Vendeur"]);
                          if($vendeur)
                          {
                              $boutique = $vendeur->fetch_assoc()["Boutique"];
                              echo '<a href="../Vendeur/boutique.php?id='. $item["ID_Vendeur"] . '"> ' . $boutique . '</a>';
                          } ?>
                      <?php if ($row["Instigateur"] == "Acheteur") echo 'de ';
            ...
            <tr>
            	<?php if ($row["Instigateur"] == "Vendeur") {?>
                <td>
